...
export declare function findLegacyLaunchAgents(env: GatewayServiceEnv): Promise<LegacyLaunchAgent[]>;
export declare function uninstallLegacyLaunchAgents({ env, stdout, }: GatewayServiceManageArgs): Promise<LegacyLaunchAgent[]>;
