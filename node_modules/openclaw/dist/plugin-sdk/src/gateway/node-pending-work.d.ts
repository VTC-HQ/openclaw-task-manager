export declare const NODE_PENDING_WORK_TYPES: readonly ["status.request", "location.request"];
export type NodePendingWorkType = (typeof NODE_PENDING_WORK_TYPES)[number];
export declare const NODE_PENDING_WORK_PRIORITIES: readonly ["default", "normal", "high"];
