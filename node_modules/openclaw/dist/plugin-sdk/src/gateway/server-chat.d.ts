...
export declare function createAgentEventHandler({ broadcast, broadcastToConnIds, nodeSendToSession, agentRunSeq, chatRunState, resolveSessionKeyForRun, clearAgentRunContext, toolEventRecipients, sessionEventSubscribers, lifecycleErrorRetryGraceMs, isChatSendRunActive, }: AgentEventHandlerOptions): (evt: AgentEventPayload) => void;
