...
export declare const APPROVAL_NOT_FOUND_DETAILS: {
    readonly reason: "APPROVAL_NOT_FOUND";
};
...
export declare function respondUnknownOrExpiredApproval(respond: RespondFn): void;
