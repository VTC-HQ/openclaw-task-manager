...
import type { ExecHostRequest, ExecHostResponse } from "../infra/exec-host.js";
import type { ExecEventPayload, ExecFinishedEventParams, RunResult, SkillBinsProvider, SystemRunParams } from "./invoke-types.js";
...
export type HandleSystemRunInvokeOptions = {
    ...
    runCommand: (argv: string[], cwd: string | undefined, env: Record<string, string> | undefined, timeoutMs: number | undefined) => Promise<RunResult>;
...
export declare function handleSystemRunInvoke(opts: HandleSystemRunInvokeOptions): Promise<void>;
