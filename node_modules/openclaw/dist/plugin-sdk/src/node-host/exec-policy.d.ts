...
export declare function resolveExecApprovalDecision(value: unknown): ExecApprovalDecision;
export declare function formatSystemRunAllowlistMissMessage(params?: {
    shellWrapperBlocked?: boolean;
    windowsShellWrapperBlocked?: boolean;
}): string;
export declare function evaluateSystemRunPolicy(params: {
