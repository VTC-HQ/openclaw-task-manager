...
export declare function writeClawHubSkillsLockfile(workspaceDir: string, lockfile: ClawHubSkillsLockfile): Promise<void>;
export declare function readClawHubSkillOrigin(skillDir: string): Promise<ClawHubSkillOrigin | null>;
export declare function writeClawHubSkillOrigin(skillDir: string, origin: ClawHubSkillOrigin): Promise<void>;
...
export declare function computeSkillFingerprint(skillDir: string): Promise<string>;
export {};
