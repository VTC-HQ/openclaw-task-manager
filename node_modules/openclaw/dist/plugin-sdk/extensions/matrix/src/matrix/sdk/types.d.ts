...
export type VideoFileInfo = DimensionalFileInfo & TimedFileInfo & {
    duration?: number;
};
...
export type MatrixUiAuthCallback = <T>(makeRequest: (authData: MatrixAuthDict | null) => Promise<T>) => Promise<T>;
